...
export interface ReactWrapperRow {
  readonly id: string;
...
export const reactWrapperRows: readonly ReactWrapperRow[] = Object.freeze([
  {
    id: "WR-0001",
    department: "Treasury",
    program: "Budget approval",
    memo: "React renderer bridge",
    owner: "Han",
    amount: 1200,
    status: "Ready"
  },
...
export const reactWrapperColumns: readonly ColumnDef<ReactWrapperRow>[] = Object.freeze([
  {
    field: "id",
    headerName: "ID",
    pinned: "left",
...
export const reactWrapperOptions: Pick<
  GridOptions<ReactWrapperRow>,
